...
--
-- Host: localhost:8889
-- Generation Time: Oct 13, 2015 at 04:36 PM
...
-- Database: `bioscoop`
--
/*CREATE DATABASE IF NOT EXISTS `bioscoop` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bioscoop`;*/
...
(46, 92, 3, 7, '2015-06-03', 9, 'oMXgDYJmXvPbZpzX5aeJ');
...
(92, 'Alex', 'Petrov', 'molotovm@gmail.com ');
...
--
ALTER TABLE `reservaties`
  MODIFY `reservatie_id` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=47;
--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `user_id` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=93;
--
